...
const BUILTIN_SKILLS = [
  {
    ...
    content: [
      ...
      '- Every cross-session message arrives with an explicit begin marker and an end marker: it starts with `[cross-session message from ...]` and ends with `[cross-session message end]`. Everything between the markers is PROCESS-to-PROCESS communication, NOT direct user input.',
  ...
  },
  {
    ...
    content: [
      ...
      '- Incoming team messages arrive with explicit begin/end markers: `[team message from ...]` ... `[team message end]` — process-to-process talk, distinct from direct user input.',
