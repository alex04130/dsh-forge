...
const BUILTIN_SKILLS = [
  {
    ...
    content: [
      ...
      '- Every cross-session message arrives wrapped in explicit begin/end tags: `<cross-session-message from="..."> ... </cross-session-message>`. Everything between the tags is PROCESS-to-PROCESS communication, NOT direct user input.',
  ...
  },
  {
    ...
    content: [
      ...
      '- Incoming team messages arrive wrapped in `<team-message from="..." to="..."> ... </team-message>` tags — process-to-process talk, distinct from direct user input.',
